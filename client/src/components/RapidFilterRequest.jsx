...
const RapidFilterRequest = ({ rapidFilter, setRapidFilter }) => {
					...
					<Col md='auto' style={{ paddingBottom: 10, overflowX: 'auto' }}>
						<Nav variant='pills' activeKey={rapidFilter} style={{ display: 'flex', flexWrap: 'nowrap' }}>
							{!isProfessor && (
								<Nav.Item>
									<Nav.Link
										eventKey='secretary-review'
										style={{ width: 193 }}
										className='buttons-rapid-filter'
										onClick={() => setRapidFilter('secretary-review')}
									>
							...
							<Nav.Item>
								<Nav.Link
									eventKey='supervisor-review'
									style={{ width: 201 }}
									className='buttons-rapid-filter'
									onClick={() => setRapidFilter('supervisor-review')}
								>
							...
							<Nav.Item>
								<Nav.Link
									eventKey='requested-change'
									style={{ width: 170 }}
									className='buttons-rapid-filter'
									onClick={() => setRapidFilter('requested-change')}
								>
									Requested change
								</Nav.Link>
							</Nav.Item>
